<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Part_084.WebForm1" %>
...
<body>
    ...
    <div>
        <table style="border: 1px solid black; font-family: Arial; text-align: center">
            ...
            <tr>
                <td>
                    <asp:TextBox ID="txtCounter1" Width="150px" Font-Size="Large" runat="server" BackColor="#000099"
                        ForeColor="White">
                    </asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtCounter2" Width="150px" Font-Size="Large" runat="server" BackColor="#000099"
                        ForeColor="White">
                    </asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtCounter3" Width="150px" Font-Size="Large" runat="server" BackColor="#000099"
                        ForeColor="White">
                    </asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="3">
                    <asp:TextBox ID="txtNextToken" Font-Size="Large" Width="500px" runat="server" BackColor="#003300"
                        ForeColor="White">
                    </asp:TextBox>
                </td>
            </tr>
